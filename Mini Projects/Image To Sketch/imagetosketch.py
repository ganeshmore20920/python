...
def dodge(front, back):
    ...
    #and units is for 8-bit signed integer
...
i = 255-gray  #0,0,0 is for the darkest color and 255,255,255 is for brightest color which is probably white color

#to convert it into blur image
blur = scipy.ndimage.filters.gaussian_filter(i,sigma = 15)
#sigma is the intensity of blurness of image
r = dodge(blur,gray) # this function will convert our image to sketch by taking two parameeter as blur and grey

cv2.imwrite('baymax-sketch.png',r)